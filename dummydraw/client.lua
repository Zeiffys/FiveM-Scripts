Citizen.CreateThread(function()
	...
	local pedbonesatzero = false -- default false
	...
	local carbonesstr = {"aileron_l", "aileron_r", "attach_female", "attach_male", "bobble_head", "bodyshell", "bogie_f", "bogie_r", "bonnet", "boot", "bottle01", "bottle02", "bottle03", "bottle04", "bottle05", "brakelight_l", "brakelight_m", "brakelight_r", "bucket", "bump_front_ok", "bumper", "bumper_f", "bumper_r", "chassis", "chassis_dummy", "chassis_lowlod", "cockpit", "crane", "dashglow", "dashglow001", "daylight_l", "dials", "door_dside_f", "door_dside_r", "door_pside_f", "door_pside_r", "doorlight_lf", "doorlight_lr", "doorlight_rf", "doorlight_rl", "doorlight_rr", "elevator_l", "elevator_r", "emissives", "engine", "engineblock", "exhaust", "exhaust2", "exhaust_1", "exhaust_2", "exhaust_3", "exhaust_4", "exhaust_5", "exhaust_6", "exhaust_7", "exhaust_8", "extra_1", "extra_11", "extra_12", "extra_13", "extra_14", "extra_15", "extra_16", "extra_17", "extra_18", "extra_19", "extra_2", "extra_3", "extra_4", "extra_5", "extra_6", "extra_7", "extra_8", "extra_9", "extra_ten", "extralight_1", "extralight_2", "extralight_3", "extralight_4", "gauges", "gear_door_fl", "gear_door_fr", "gear_door_rl1", "gear_door_rl2", "gear_door_rr1", "gear_door_rr2", "gear_f", "gear_rl", "gear_rr", "handle_dside_f", "handle_dside_r", "handle_pside_f", "handle_pside_r", "hbgrip_l", "hbgrip_r", "headlight_l", "headlight_r", "headlights", "hub_lf", "hub_lm1", "hub_lm2", "hub_lm3", "hub_lr", "hub_rf", "hub_rm1", "hub_rm2", "hub_rm3", "hub_rr", "indicator_lf", "indicator_lr", "indicator_rf", "indicator_rr", "inkpot01", "inkpot02", "interior_1", "interior_2", "interior_3", "interior_4", "interior_detail", "interiorlight", "ladder", "legs", "lights", "misc_a", "misc_b", "misc_c", "misc_d", "misc_e", "misc_f", "misc_g", "misc_h", "misc_i", "misc_j", "misc_k", "misc_l", "misc_m", "misc_n", "misc_o", "misc_p", "misc_q", "misc_r", "misc_s", "misc_t", "misc_u", "misc_v", "misc_w", "misc_x", "misc_y", "misc_z", "mod_col_1", "mod_col_2", "mod_col_3", "mod_col_4", "mod_col_5", "mod_col_6", "mod_col_7", "mod_col_8", "mod_col_9", "modelmesh_rl", "modelmesh_rr", "neon_b", "neon_f", "neon_l", "neon_r", "overheat", "overheat_2", "petrolcap", "petroltank", "petroltank_l", "petroltank_r", "plate_r", "platelight", "radio", "reversinglight_l", "reversinglight_r", "roof", "rotor_main", "rotor_main_fast", "rotor_main_slow", "rotor_rear", "rotor_rear_fast", "rotor_rear_slow", "rudder", "rudder2", "scoop", "seat_dside_f", "seat_dside_f001", "seat_dside_r", "seat_dside_r1", "seat_dside_r2", "seat_dside_r3", "seat_pside_f", "seat_pside_f001", "seat_pside_r", "seat_pside_r1", "seat_pside_r2", "seat_pside_r3", "seats", "siren1", "siren10", "siren11", "siren12", "siren13", "siren14", "siren15", "siren16", "siren17", "siren18", "siren19", "siren2", "siren20", "siren21", "siren22", "siren23", "siren24", "siren25", "siren26", "siren27", "siren28", "siren29", "siren3", "siren4", "siren5", "siren6", "siren7", "siren8", "siren9", "siren_glass1", "siren_glass10", "siren_glass11", "siren_glass12", "siren_glass13", "siren_glass14", "siren_glass15", "siren_glass16", "siren_glass17", "siren_glass18", "siren_glass19", "siren_glass2", "siren_glass3", "siren_glass4", "siren_glass5", "siren_glass6", "siren_glass7", "siren_glass8", "siren_glass9", "slipstream_l", "slipstream_r", "soft_1", "soft_2", "soft_3", "soft_4", "soft_5", "soft_6", "spoiler", "static_prop", "static_prop2", "steeringwheel", "struts", "suspension_lf", "suspension_lm", "suspension_lr", "suspension_rf", "suspension_rm", "suspension_rr", "taillight_l", "taillight_r", "thrust", "track_l", "track_r", "transmission_f", "transmission_m", "transmission_r", "wheel_lf", "wheel_lm1", "wheel_lm2", "wheel_lr", "wheel_rf", "wheel_rm1", "wheel_rm2", "wheel_rr", "wheelmesh_lf", "wheelmesh_lf_l1", "wheelmesh_lf_l2", "wheelmesh_lf_ng", "wheelmesh_lr", "wheelmesh_lr_l1", "wheelmesh_lr_l2", "wheelmesh_lr_ng", "wheelmesh_rf", "window_lf", "window_lf1", "window_lf2", "window_lm", "window_lm1", "window_lm2", "window_lm3", "window_lr", "window_lr1", "window_rf", "window_rf1", "window_rf2", "window_rm", "window_rm1", "window_rm2", "window_rm3", "window_rr", "window_rr1", "windowsl", "windowsr", "windscreen", "windscreen[L1]", "windscreen_left", "windscreen_r", "windscreen_right", "wing_l", "wing_lf", "wing_lr", "wing_r", "wing_rf", "wing_rr", "wingtip_1", "wingtip_2"}
	...
	while true do
		...
		if inVehicle then
			...
			for k, v in ipairs(carbonesstr) do
				...
				if Vdist(bone.x, bone.y, bone.z, 0.0, 0.0, 0.0) > 0.005 then
			...
			if pedbones then
				...
				for k, v in ipairs(pedbonesid) do
					...
					if Vdist(bone.x, bone.y, bone.z, pedpos.x, pedpos.y, pedpos.z) > 0.0025 then
						DrawBox(bone.x - pedsize, bone.y - pedsize, bone.z - pedsize, bone.x + pedsize, bone.y + pedsize, bone.z + pedsize, 0, 255, 0, 220)
					else
						if pedbonesatzero then
							DrawBox(bone.x - pedsize, bone.y - pedsize, bone.z - pedsize, bone.x + pedsize, bone.y + pedsize, bone.z + pedsize, 255, 0, 0, 220)
							what = what .. v .. " / "
						end
					end
				end
